...
// @downloadURL  https://github.com/Hunga9k50doker/Blum-x-Tampermonkey/raw/main/ScriptTamperMonkey.js
// @updateURL    https://github.com/Hunga9k50doker/Blum-x-Tampermonkey/raw/main/ScriptTamperMonkey.js
// @homepage     https://github.com/Hunga9k50doker/Blum-x-Tampermonkey
// ==/UserScript==
...
try {
  ...
  settingsMenu.appendChild(
    createSettingElement("Flower Skip (%)", "flowerSkipPercentage", "range", 0, 100, 1, "EN: Percentage probability of skipping a flower.<br>" + "RU: Вероятность пропуска цветка в процентах.")
  );
  settingsMenu.appendChild(
    createSettingElement("Min Freeze Hits", "minIceHits", "range", 1, 10, 1, "EN: Minimum number of clicks per freeze.<br>" + "RU: Минимальное количество кликов на заморозку.")
  );
  settingsMenu.appendChild(createSettingElement("Min Bomb Hits", "minBombHits", "range", 0, 10, 1, "EN: Minimum number of clicks per bomb.<br>" + "RU: Минимальное количество кликов на бомбу."));
  settingsMenu.appendChild(createSettingElement("Min Delay (ms)", "minDelayMs", "range", 10, 10000, 10, "EN: Minimum delay between clicks.<br>" + "RU: Минимальная задержка между кликами."));
  settingsMenu.appendChild(createSettingElement("Max Delay (ms)", "maxDelayMs", "range", 10, 10000, 10, "EN: Maximum delay between clicks.<br>" + "RU: Максимальная задержка между кликами."));
  settingsMenu.appendChild(
  ...
  githubButton.href = "https://github.com/Hunga9k50doker/Blum-x-Tampermonkey";
  ...
  donateButton.href = "https://Hunga9k50doker.codes/donate/";
